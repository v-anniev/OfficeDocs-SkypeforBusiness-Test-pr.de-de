...
ms:mtpsurl: https://technet.microsoft.com/de-de/library/JJ945598(v=OCS.15)
ms:contentKeyID: 52056031
ms.date: 06/25/2014
...
1.  Set the Windows PowerShell execution policy to Unrestricted. To check your execution policy settings, open the Lync Server-Verwaltungsshell and run the following command:
    ```Powershell
        Get-ExecutionPolicy
    ```
